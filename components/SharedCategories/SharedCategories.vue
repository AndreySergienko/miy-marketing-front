      ...
      <div v-if="isOpen" class="categories__list">
        <div class="container">
          ...
          <div class="categories__items">
            <div
              v-for="(categoriesItem, index) in categoriesList"
              :key="categoriesItem.title + index"
              :class="[
                'categories__item',
            ...
            >
              ...
              <div v-if="categoriesItem.count" class="categories__item-number">
...
import type {
  ISharedCategoriesEmits,
  ISharedCategoriesProps,
} from "~/components/SharedCategories/SharedCategories.type";
